...
(function (___m) {
  ...
  return ___m.bind((((0 === (opt.argv)["length"]) && (0 === (Object.keys(opt.options))["length"])) ?
        (function() {
...
return       (function() {
    ...
    return ___m.bind(((true === opt.options['version']) ?
            (function() {
      ...
      ((true === opt.options['browser-bundle']) ?
        ...
        ((true === opt.options['run']) ?
          ...
          let infile = (opt.argv[0] ?
            (((opt.argv[0].indexOf('.lisp') === -1) && (opt.argv[0].indexOf('.js') === -1)) ?
          ...
          ((true === opt.options['watch']) ?
            ...
            watch.watchTree(cwd,{
              filter: function (f,stat) {
                return (stat.isDirectory() || (f.indexOf('.lisp') !== -1));
              },
              ignoreDotFiles: true,

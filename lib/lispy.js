...
let opt = require("node-getopt").create([
  ...
  [
    "b",
    "browser-bundle",
    "create browser-bundle.js in the same directory"
  ],
  [
    "m",
    "map",
...
(function (__m) {
  ...
  return __m.bind((((0 === (opt.argv)["length"]) && (0 === (Object.keys(opt.options))["length"])) ?
        (function() {
...
return       (function() {
    ...
    return __m.bind(((true === opt.options["version"]) ?
            (function() {
      ...
      ((true === opt.options["browser-bundle"]) ?
        ...
        ((true === opt.options["run"]) ?
          ...
          let infile = (opt.argv[0] ?
            (((opt.argv[0].indexOf(".kirby") === -1) && (opt.argv[0].indexOf(".lisp") === -1) && (opt.argv[0].indexOf(".js") === -1)) ?
          ...
          ((true === opt.options["watch"]) ?
            ...
            watch.watchTree(cwd,{
              filter: function (f,stat) {
                return (stat.isDirectory() || (f.indexOf(".kirby") !== -1) || (f.indexOf(".lisp") !== -1));
              },
              ignoreDotFiles: true,
              ignoreDirectoryPattern: /node_modules/
            },function (f,curr,prev) {
              return ((curr && (curr.nlink !== 0)) ?
                require("child_process").spawn("lispy",[
                  f.substring((1 + (cwd1)["length"]))
                ],{
                  stdio: "inherit"
                }) :
                (((Object.prototype.toString.call(f) === "[object Object]") && (Object.prototype.toString.call(prev) === "[object Null]") && (Object.prototype.toString.call(curr) === "[object Null]")) ?
                  (function (o,f,s) {
                    ...
                    return ((!(initialf === cwd)) ?
                                            (function() {
                      return require("child_process").spawn("lispy",[
                        initialf.substring((1 + (cwd)["length"]))
                      ],{
                        stdio: "inherit"
                      });
                      })() :
      ...
      return __m.bind((opt.argv[0] ?
        opt.argv[0] :
        error(new Error("Error: No Input file given"))),function (infile) {
        return __m.bind(        (function() {
        let outfile = opt.argv[1];
        return         (function() {
        ((!outfile) ?
                    (function() {
          (infile.endsWith(".kirby") ?
            outfile = infile.replace(/\.kirby$/,".js") :
            undefined);
          (infile.endsWith(".lisp") ?
            outfile = infile.replace(/\.lisp$/,".js") :
            undefined);
        ...
        return outfile;
          ...
          return (function () {
            ...
            try {
              ...
              ((!dbgAST) ?
                                (function() {
                return console.log(["lispy v",ls.version,":  compiling: ",infile," -> ",outfile].join(""));
                })() :
                undefined);
